...
# CamFish v1.0
# Powered by FI Ridon
# Credits goes to thelinuxchoice [github.com/thelinuxchoice/] and techchipnet [github.com/techchipnet/]
...
sed 's+forwarding_link+'$link'+g' wishepage.html > index3.html
